package cc.qtimes.opengl.glhelper;
...
public class TextureProgram extends ShaderProgram {
    ...
    private static final float FULL_RECTANGLE_COORDS_R[] = {
            -1.0f,  1.0f,   // 2 top left
            1.0f,  1.0f,   // 3 top right
            -1.0f, -1.0f,   // 0 bottom left
            1.0f, -1.0f,   // 1 bottom right
    ...
    private static final FloatBuffer FULL_RECTANGLE_BUF_R =
            GlUtil.createFloatBuffer(FULL_RECTANGLE_COORDS_R);
